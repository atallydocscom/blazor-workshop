/**
 * Displays or updates a map with markers in a specified HTML element.
 * @param {string} elementId - The ID of the HTML element where the map should be displayed.
 * @param {Array<Object>} markers - An array of marker objects, each containing x (longitude), y (latitude), description, and optionally showPopup properties.
